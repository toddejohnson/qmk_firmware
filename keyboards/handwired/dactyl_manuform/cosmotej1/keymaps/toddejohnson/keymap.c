...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,             KC_N,    KC_M,  KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
                                        ...
                                        KC_LALT, KC_BSPC, KC_LSFT, KC_RSFT, KC_DEL, KC_LGUI
    ),

    [_RAISE] = LAYOUT(
        KC_GRV ,      _______, _______,    _______,    KC_END,     _______,        _______,    _______, _______, _______, KC_HOME ,   _______,  _______,
        LALT(KC_TAB), _______, _______,    _______,    _______,    KC_TRNS,        LCTL(KC_V), _______, KC_INS,  _______, LCTL(KC_C), KC_VOLU,  _______,    _______,
    ...
    [_LOWER] = LAYOUT(
        ...
        LALT(KC_TAB), _______, _______,    _______,    _______,    KC_LBRC,        KC_RBRC, KC_P7,   KC_P8,   KC_P9,   KC_PSCR, KC_VOLU,    _______,    _______,
